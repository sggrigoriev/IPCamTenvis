...
EXTERN WRITER* GetDefaultWriter();
EXTERN WRITER *GetWriter();
EXTERN void SetWriter(WRITER *pWrtr);

EXTERN READER *GetDefaultReader();
EXTERN READER* GetDefaultRemoteReader();
EXTERN BOOL RegisterReader(READER *pReader);
EXTERN READER *FindSuitableReader(const char *sFileName, FILEINFO *pFi);

EXTERN DWORD DefaultRepair(const char *fn);
//=======================================================================================
//=======================================================================================
#ifdef __cplusplus
}
